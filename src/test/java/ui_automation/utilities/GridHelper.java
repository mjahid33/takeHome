...
public class GridHelper extends GenericHelper{
    ...
    public static String getHeaderXpath(String tableIdoRxPath){
    ...
    public static String getTableBodyXpath(String tableIdoRxPath){
        oLog.debug(tableIdoRxPath);
        return IsElementPresentQuick(By.id(tableIdoRxPath)) ? "//table[@id='" + tableIdoRxPath + "']//tbody" : tableIdoRxPath + "//tbody";
    }

    public static WebElement getGridElement(String tableIdoRxPath, int row, int column){
    ...
    public static int searchInGrid(String description,String tableIdoRxPath,int row,final int column){
    ...
    public static List<String> getGridHeading(String tableIdoRxPath){
    ...
    public static String getGridColumnText(String tableIdoRxPath,int row,int column) {
    ...
    public static void typeInGrid(String tableIdoRxPath,int row,int column,String value) {
    ...
    public static void typeInGrid(String description,String tableIdoRxPath,int row,int column,String value) {
